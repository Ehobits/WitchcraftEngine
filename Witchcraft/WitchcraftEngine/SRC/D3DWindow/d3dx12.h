...
struct CD3DX12_CPU_DESCRIPTOR_HANDLE : public D3D12_CPU_DESCRIPTOR_HANDLE
{
	...
	{
		ptr += (UINT64)offsetInDescriptors * descriptorIncrementSize;
		return *this;
	}
	...
	{
		handle.ptr = base.ptr + (UINT64)offsetInDescriptors * descriptorIncrementSize;
	}
};
	...
	case D3D_ROOT_SIGNATURE_VERSION_1_0:
		...
		case D3D_ROOT_SIGNATURE_VERSION_1_1:
		{
			...
			if (pParameters)
			{
				for (UINT n = 0; n < desc_1_1.NumParameters; n++)
				{
					pParameters_1_0[n].DescriptorTable.pDescriptorRanges = nullptr;
