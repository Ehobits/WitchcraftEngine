...
bool ShadowMap::MatchesLayout(const std::vector<UINT>& desiredSizes) const
{
...
void ShadowMap::RebuildShadowMaps(
...
CD3DX12_CPU_DESCRIPTOR_HANDLE ShadowMap::GetDsvHandle(UINT index) const
{
...
const CD3DX12_VIEWPORT& ShadowMap::GetViewport(UINT index) const
{
...
const CD3DX12_RECT& ShadowMap::GetScissorRect(UINT index) const
{
...
ShadowMap::ShadowMapLayout ShadowMap::GetLayout() const
{
