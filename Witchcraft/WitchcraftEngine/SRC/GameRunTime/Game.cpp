...
#include "ENTITY/COMPONENT/ScriptingComponent.h"

bool Game::StartGame(D3DWindow* dx, Entity* ecs, HWND parent)
{
	m_dx = dx;
	m_ecs = ecs;
	hwnd = parent;
	...
	auto view = m_ecs->registry.view<ScriptingComponent>();
	for (auto entity : view)
		m_ecs->registry.get<ScriptingComponent>(entity).lua_call_start();
...
//
//		if (FAILED(factory->CreateSwapChain(dx->dxDevice, &sd, &gameSwapChain)))
//			return false;
//
...
//	///////////////////////////////////////////////////////////
//
//	if (FAILED(m_dx->GetDevice()->CreateRenderTargetView(tex, NULL, &gameRenderTargetView)))
//		return false;
//
//	///////////////////////////////////////////////////////////
//
...
//
//	ID3D11Texture2D* tex = nullptr;
//	if (FAILED(m_dx->GetDevice()->CreateTexture2D(&descDepth, NULL, &tex)))
//		return false;
//
//	///////////////////////////////////////////////////////////
//
...
//
//	if (FAILED(m_dx->GetDevice()->CreateDepthStencilView(tex, &descDSV, &gameDepthStencilView)))
//		return false;
//
//	///////////////////////////////////////////////////////////
//
