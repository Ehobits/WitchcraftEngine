...
void ConsoleWindow::AddDebugMessage(const wchar_t* text, ...)
{
#if defined(_DEBUG)
...
void ConsoleWindow::AddInfoMessage(const wchar_t* text, ...)
{
	if (std::wstring(text).empty())
		return;
...
void ConsoleWindow::AddWarningMessage(const wchar_t* text, ...)
{
	if (std::wstring(text).empty())
		return;
...
void ConsoleWindow::AddErrorMessage(const wchar_t* text, ...)
{
	if (std::wstring(text).empty())
		return;
